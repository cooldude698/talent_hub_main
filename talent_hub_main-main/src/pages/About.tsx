  ...
  <div className="py-16 md:py-24">
    <div className="container mx-auto px-4">
      <SectionHeading
        ...
        description="RAWGENN was founded on a simple belief: talent should be discovered, not auctioned."
      />
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="mx-auto mt-12 md:mt-16 max-w-3xl glass-card p-6 sm:p-8 md:p-12"
      >
        <p className="text-muted-foreground leading-relaxed">
          Unlike open marketplaces where anyone can list their services, RAWGENN operates as a managed agency. Every freelancer on our platform is hand-picked, verified, and continuously evaluated. When you submit a project, our team reviews your requirements and assigns the most qualified professional — no bidding, no price wars.
        </p>
